...
def generate_urban_terrain(grid_size=150, area_dim=500, num_hills=6, num_buildings=24, hill_min_height = 20, hill_max_height=160):
    """
...
x_coords, y_coords, X_mesh, Y_mesh, Z = generate_urban_terrain() 
...
# --- 5. Set Controls ---
phase.add_control('ax', lower=-9, upper=9, units='m/s**2', ref=5)
phase.add_control('ay', lower=-9, upper=9, units='m/s**2', ref=5)
...
prob.set_val('traj.phase0.states:z', phase.interp('z', [z_start + 10., z_end + 10.]))
