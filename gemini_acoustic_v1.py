...
landmarks = [
    (100.0, 100.0, 0., 55.0, 3.0),  # Hospital (Very Quiet, High Priority)
...
grid_x = np.linspace(300, 350, 5)
grid_y = np.linspace(350, 450, 5)
...
class ObjectiveComp(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        outputs['J'] = 0.002 * inputs['time'] + 0.05*inputs['total_lp_dose']
