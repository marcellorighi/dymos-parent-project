...
def generate_urban_terrain(seed = None, grid_size=150, area_dim=500, num_hills=12, num_buildings=25, hill_min_height = 20, hill_max_height=160, hill_min_width = 20., hill_max_width = 320.):
    """
...
prob.set_val('traj.phase0.states:x', phase.interp('x', xs =[0, 0.25, 0.75, 1], ys= [-area_dim+100, -area_dim+100, area_dim+100, area_dim - 100]))
prob.set_val('traj.phase0.states:y', phase.interp('y', xs =[0, 0.25, 0.75, 1], ys= [-area_dim + 100, area_dim - 100., -area_dim+100, area_dim - 100]))
